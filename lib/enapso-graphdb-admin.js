...
const EnapsoQleverAdmin = require('./enapso-qlever-admin');
...
*/
    ...
    clearRepository() {
        if (this.triplestore == 'graphdb') {
            ...
            return EnapsoQleverAdmin.clearDataSet(this);
        }
    },
    ...
    getContexts() {
        if (this.triplestore == 'graphdb') {
            ...
            return EnapsoQleverAdmin.getContexts(this);
        }
    },
    ...
    clearContext(options) {
        if (this.triplestore == 'graphdb') {
            ...
            return EnapsoQleverAdmin.clearSpecificGraph(
                { graph: options },
                this
            );
        }
    ...
    async upload(aOptions) {
        if (this.triplestore == 'graphdb') {
            ...
            return EnapsoQleverAdmin.uploadOntology(
                {
                    data: aOptions.data,
                    graph: aOptions.context,
                    format: aOptions.format
